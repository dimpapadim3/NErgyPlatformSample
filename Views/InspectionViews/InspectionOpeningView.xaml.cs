...
{
    public partial class InspectionOpeningView : UserControl
    {
 
        public InspectionOpeningView()
        {
            InitializeComponent();
      ...
      typeof(InspectionOpeningView), new PropertyMetadata(null, TransparentElementPropertyChangedCallBack));
