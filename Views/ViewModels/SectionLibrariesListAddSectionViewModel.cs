...
{
    public class SectionLibrariesListAddSectionViewModel : ViewModelBase<SectionLibrariesListAddSectionViewModel>
    {
        ...
        public SectionLibrariesListAddSectionViewModel()
        {
            userID = 1;
            LoadLibraries();
        }
        ...
        public string  SectionName
        {
            ...
            {
                _sectionName = value;
                NotifyPropertyChanged(vm => vm.SectionName);
            }
        }
        ...
        public DelegateCommand AddToLibraryCommand
        {
            get
            {
                return new DelegateCommand(() =>
                                               ...
                                               {
                                                   this.DataAccesLayerService.AddSectionToLibrary(new Section(){Name=SectionName,U = this.U},SelectedLibrary);
                                                   DataAccesLayerService.SaveChanges(error => ItemsSaved(error));
                                                   this.LoadSectionsForLibrary();
                                               }
        ...
        public void Add(Library item)
        {
            if (item != null)
            {
                ...
                DataAccesLayerService.SaveChanges((c => { }));
                LoadLibraries();
            }
        }
        ...
        public void OpenNewLibraryEditor()
        {
            ...
            dialog.Closed += (s, e) =>
            {
                this.Add(libraryEditor.ViewModel.Library);
